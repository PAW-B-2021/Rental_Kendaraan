...
namespace RentalKendaraan.Controllers
{
    public class KendaraansController : Controller
    {
        ...
        {
            ViewData["IdJenisKendaraan"] = new SelectList(_context.JenisKendaraan, "IdKendaraan", "IdKendaraan");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaKendaraan,NoPolisi,NoStnk,IdJenisKendaraan,Ketersediaan")] Kendaraan kendaraan)
        {
            ...
            ViewData["IdJenisKendaraan"] = new SelectList(_context.JenisKendaraan, "IdKendaraan", "IdKendaraan", kendaraan.IdJenisKendaraan);
            return View(kendaraan);
        }
