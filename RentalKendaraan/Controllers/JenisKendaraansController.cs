...
namespace RentalKendaraan.Controllers
{
    public class JenisKendaraansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaJenisKendaraan")] JenisKendaraan jenisKendaraan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKendaraan,NamaJenisKendaraan")] JenisKendaraan jenisKendaraan)
        {
